...
for i=1:numPeople,
	...
	if par(1)==0 && par(2)==0,
		...
		factorList(i) = childCopyGivenParentalsFactor(numAlleles, i, par(1), par(1)+numPeople);
		factorList(i+numPeople) = childCopyGivenParentalsFactor(numAlleles, i+numPeople, par(2), par(2)+numPeople);
