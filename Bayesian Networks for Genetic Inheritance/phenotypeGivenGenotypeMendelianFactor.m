...
% map to Aa, and assignment 3 would map to aa.  For the phenotypes, 
...
if isDominant == 1,
	...
	phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1 3], 0);
	phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2 1], 0);
	phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2 2], 0);
	phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2 3], 1);

else,
	phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1 1], 0);
	phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1 2], 0);
	phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1 3], 1);
	phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2 1], 1);
	phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2 2], 1);
	phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2 3], 0);
end;	
