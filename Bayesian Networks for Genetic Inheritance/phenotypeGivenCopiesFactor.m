...
for i=1:numAlleles,
	for j=1:numAlleles,
		...
		idx = AssignmentToIndex([1 i j], phenotypeFactor.card);
		phenotypeFactor.val(idx) = phenotypeFactor.val(idx) + alphaList(genotype_id);
	end;
end;

for i=1:numAlleles,
	for j=1:numAlleles,
		idx1 = AssignmentToIndex([1 i j], phenotypeFactor.card);
		idx2 = AssignmentToIndex([2 i j], phenotypeFactor.card);
		phenotypeFactor.val(idx2) = 1 - phenotypeFactor.val(idx1);
	end;
end;
